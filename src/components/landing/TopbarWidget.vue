...
<template>
    <a class="flex items-center" href="#">
        <div class="flex items-center justify-center bg-primary text-white rounded-xl mr-3" style="width: 3rem; height: 3rem">
            <i class="pi pi-building !text-xl"></i>
        </div>
        <span class="text-surface-900 dark:text-surface-0 font-semibold text-2xl leading-normal mr-20">Phena SMS</span>
    </a>
